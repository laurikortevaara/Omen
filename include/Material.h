...
namespace omen {
    class Material {
		...
		GLfloat m_diffuseIntensity; // Diffuse Intensity in Blender
        GLfloat m_specularIntensity; // Specular Intensity in Blender
		GLfloat m_shininess; // Specular Hardness in Blender
		GLfloat m_emissive_factor;
        Texture *m_texture;
