...
uint32_t tex_output;
uint32_t tex_output2;
uint32_t tex_htilde0;
...
void OceanRenderer::compute_ocean_mapping()
{
	...
	uint32_t ssbo_binding_point_index = 2;
	...
	// Do the computation
	glDispatchCompute((uint32_t)Nx, (uint32_t)Nz, 1);
...
void OceanRenderer::compute_htilde0()
{
	...
	// Do the computation
	glDispatchCompute((uint32_t)129 * 129 / 129, (uint32_t)1, 1);
